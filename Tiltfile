...
# Update ntt_config.go (https://github.com/wormhole-foundation/wormhole/blob/main/node/pkg/accountant/ntt_config.go#L52)
...
docker_build(
    ...
    context = "./.native-token-transfers/",
    only = ["./sdk", "./solana"],
    ignore=["./sdk/__tests__", "./sdk/Dockerfile", "./sdk/ci.yaml", "./sdk/**/dist", "./sdk/node_modules", "./sdk/**/node_modules"],
    dockerfile = "./.native-token-transfers/solana/Dockerfile",
)
docker_build(
    ref = "solana-test-validator",
    context = "./.native-token-transfers/solana",
    dockerfile = "./.native-token-transfers/solana/Dockerfile.test-validator"
)
k8s_yaml_with_ns("./.native-token-transfers/solana/solana-devnet.yaml")
k8s_resource(
    "solana-devnet",
    labels = ["anchor-ntt"],
    port_forwards = [
...
docker_build(
    ...
    context = "./.native-token-transfers/evm",
    dockerfile = "./.native-token-transfers/evm/Dockerfile",
)
